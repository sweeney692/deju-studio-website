...
13. **Flyer follow-ups (`marketing/flyer/`).** The `marketing/` tree is now committed (build pipeline + final flyers; raw photos/inspiration/drafts live in gitignored `_source/`, retired directions in gitignored `_archive/`). Open items:
